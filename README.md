...
备考IELTS前的英语应试基础：计算机类专业 高考120 四级560 六级裸考480 考研58 


IELTS投入时间：3.3-4.20(1.5个月) 每日1.5h-4h 总共约100h

目标： 总分 ≥ 6.5 各部分 ≥ 5.5

如上，从小学到大学我英语一直都不算很好，追求也不高（6.5分可以满足除英美个别学校以外几乎所有学校的本科/研究生英语门槛）但是这里的计划或许能帮助到不少和我基础差不多的同学以及为大家节省些收集资料的时间

不同读者的基础/分数要求/时间充裕程度都有区别，自然不太可能完全按照这里的安排，推荐先fork仓库，再手动计算&增减安排&调整计划。根目录的文档是我认为值得一读的，`/雅思全套文档` 中的文档私以为质量也不错，或许可能对你有帮助（这里的文档在本人准备过程中几乎没怎么用过）。
...
| 2025-03-23 | 6.5  |   |     |       |           | Cambridge IELTS 18 Academic Test 3 关键词识别例子：become more interesting可以联想到boring before |
