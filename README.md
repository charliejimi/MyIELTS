...
备考IELTS前的应试英语基础：工科双非 高考120 四级560 六级480 考研56 宁波中考口语21/25（微微高于平均）
...
| 2025-04-20 | 7.0   |   8.0 |     |       |           | Cambridge IELTS 16 Academic Test 1  听力即便是常规题型也有必要先审题，可能会在同时出现两个关键词时起决定作用e.g. 题目要求what decide to give 的关键词 和同时提到的 why to give 的关键词|
